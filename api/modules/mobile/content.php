...
/*
 * API for Get List Content Page
 * Methode: GET
 * Urutan Parameter
 * 1. Start Page from
 * 2. Limit Data
 * Example : [server host]/[server path]/api/mobile/content/list/0/10/
 * Return : JSON
 */
...
/*
 * API for get Detail Content by _id
 * Methode: GET
 * Urutan Parameter
 * 1. _id Content.
 * Example : [server host]/[server path]/api/mobile/content/detail/[_id Content]
 * Return : JSON
 */
 ...
 * Methode: GET
 * Example : [server host]/[server path]/api/mobile/content/count
 * Return : JSON
 */
function mobile_content_count() 
{
    $output['count']=0;
    $lilo_mongo = new LiloMongo();
    $lilo_mongo->selectDB('Articles');
