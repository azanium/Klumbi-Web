            ...
            <div id="widgetarea">
                ...
                <div id="chatbar" class="widget">
                    ...
                    <div class="widget-body collapse in" id="chatbody">
                        <ul class="">
                            <li data-stats="online"><a href="javascript:;"><img src="<?php echo base_url()."resources/image/callcenter-girls-glasses-icon.png"; ?>" alt="" /><span>Jeremy Potter</span></a></li>
                            <li data-stats="online"><a href="javascript:;"><img src="<?php echo base_url()."resources/image/callcenter-girls-glasses-icon.png"; ?>" alt="" /><span>David Tennant</span></a></li>
                            <li data-stats="online"><a href="javascript:;"><img src="<?php echo base_url()."resources/image/callcenter-girls-glasses-icon.png"; ?>" alt="" /><span>Anna Johansson</span></a></li>
                            <li data-stats="busy"><a href="javascript:;"><img src="<?php echo base_url()."resources/image/callcenter-girls-glasses-icon.png"; ?>" alt="" /><span>Eric Jackson</span></a></li>
                            <li data-stats="away"><a href="javascript:;"><img src="<?php echo base_url()."resources/image/callcenter-girls-glasses-icon.png"; ?>" alt="" /><span>Howard Jobs</span></a></li>
                            <li data-stats="offline"><a href="javascript:;"><img src="<?php echo base_url()."resources/image/callcenter-girls-glasses-icon.png"; ?>" alt=""><span>Annie Watson</span></a></li>
                        </ul>
