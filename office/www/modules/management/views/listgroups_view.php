...
$(document).ready(function() {
    ...
    dttable=$('#datatable').dataTable( {
        ...
        "bFilter": true,
        "bServerSide": true,
        "sAjaxSource": "<?php echo $this->template_admin->link("management/groups/list_data"); ?>",
...
function ubahdata(id,name,desc)
{
    $('#txtid2').val(id);
    $('#name2').val(name);
...
function hapusdata(id,pesan)
{
    BootstrapDialog.confirm(pesan, function(result){
        if(result) 
        {
            var url='<?php echo base_url(); ?>management/groups/delete/'+id;
            $.ajax({
                    type: "POST",
                    url: url,
                    data:"",
...
function settingmodule(id)
{
    var url='<?php echo base_url(); ?>management/groups/setting_load/'+id;
    $.ajax({
            type: "POST",
            url: url,
            data:"",
                ...
                <div class="panel-heading">
                    ...
                    <div class="options">
                        <ul class="nav nav-tabs">
                          <li class="active"><a href="#listdata" data-toggle="tab"><i class="icon-table"></i> Groups</a></li>
                          <li><a href="#addnewdata" data-toggle="tab"><i class="icon-plus"></i> Create Group</a></li>
                        </ul>
                ...
                <div class="panel-body collapse in">
                    <div class="tab-content">
                        <div class="tab-pane active" id="listdata">
                            ...
                            <div class="well well-lg" id="datarestrukturmenu">&nbsp;</div>
                        </div>
                        <div class="tab-pane" id="addnewdata">
                            <form method="POST" class="form-horizontal" id="brandfrm" action="<?php echo $this->template_admin->link("management/groups/cruid_groups"); ?>">
                                <div class="form-group">
                                    <input type="hidden" name="txtid" id="txtid" value="" />
                                    <label for="name" class="col-sm-3 control-label">Group Name</label>
                                    <div class="col-sm-6">
                                      <input type="text" name="name" id="name" value="" maxlength="255" placeholder="Group Name" class="form-control {required:true}" />
                                    </div>
                                    <div class="col-sm-3">
                                        <p class="help-block">Name of Group!</p>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="description" class="col-sm-3 control-label">Descriptions</label>
                                    <div class="col-sm-6">
                                      <textarea name="description" id="description" class="form-control autosize" cols="55" rows="3"></textarea>
                                    </div>
                                    <div class="col-sm-3">
                                        <p class="help-block">Descriptions of groups!</p>
                                    </div>
                                </div>                                
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <?php 
                                        if($this->m_checking->actions("Group User","module2","Add",TRUE,FALSE,"home"))
                                        {
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" id="editbrandfrm" action="<?php echo $this->template_admin->link("management/groups/cruid_groups"); ?>">
                    <table class="table table-striped table-bordered table-hover" cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            <td>
                                ...
                                <label for="name2">Group Name</label>
                            </td>
                            <td>
                                <input type="text" name="name" id="name2" value="" maxlength="255" placeholder="Group Name" class="form-control {required:true}" />
                            </td>
                        </tr>
                        <tr>
                            <td><label for="description2">Descriptions</label></td>
                            <td><textarea name="description" id="description2" class="form-control autosize" cols="55" rows="3"></textarea></td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
                            <td>
