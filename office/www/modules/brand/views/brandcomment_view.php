...
$(document).ready(function() {
    dttable=$('#datatable').dataTable( {
        ...
        "bFilter": false,
        "bServerSide": true,
        "sAjaxSource": "<?php echo $this->template_admin->link("brand/brandsosial/list_itemdatacommet/".$id_brand); ?>",
...
function hapusdata(id,pesan)
{
    BootstrapDialog.confirm(pesan, function(result){
        if(result) 
        {
            var url='<?php echo base_url(); ?>brand/brandsosial/delete/'+id;
            $.ajax({
                    type: "POST",
                    url: url,
                    data:"",
