...
$(document).ready(function() {
    dttable=$('#datatable').dataTable( {
        ...
        "bFilter": false,
        "bServerSide": true,
        "sAjaxSource": "<?php echo $this->template_admin->link("brand/bannersosial/list_itemdatacommet/".$id_banner); ?>",
...
function hapusdata(id,pesan)
{
    BootstrapDialog.confirm(pesan, function(result){
        if(result) 
        {
            var url='<?php echo base_url(); ?>brand/bannersosial/delete/'+id;
            $.ajax({
                    type: "POST",
                    url: url,
                    data:"",
        ...
        <div class="col-md-12">
            <div class="panel panel-purple">
                ...
                <div class="panel-body collapse in">
                    <p align="right">
                        <a href="<?php echo $this->template_admin->link("brand/banner/index"); ?>" class="btn btn-sm btn-info"><i class="icon-arrow-left"></i> Back</a>&nbsp;&nbsp;
