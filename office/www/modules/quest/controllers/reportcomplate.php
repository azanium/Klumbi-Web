...
class Reportcomplate extends CI_Controller 
{
    public function __construct() {
        parent::__construct();
        $this->load->library(array('session','template_admin','template_icon','tambahan_fungsi','cek_session'));
        $this->cek_session->cek_login();
        $this->m_checking->module("Report Complate Quest","module5",FALSE,TRUE,"home");
    }
    function index()
    {
        ...
        $this->template_admin->header_web(TRUE,"Quest Finish",$css,$js,TRUE,"");
        ...
        $this->load->view("report_complate",$dataadd);
