...
class Reporting extends CI_Controller 
{
    public function __construct() {
        ...
        $this->m_checking->module("Brand Report","module13",FALSE,TRUE,"home");
    }
    function index()
    {
        ...
        $this->template_admin->header_web(TRUE,"Store Report",$css,$js,TRUE,"");
        ...
        $config['base_url'] = $this->template_admin->link("reporting/index","?page=brand&dt=list");
        ...
        $isiform['listbrand']=$this->mongo_db->find(array(),(int)$start,$config['per_page'],array('name'=>1));
        $isiform['startfrom'] = (int)$start;
        $this->load->view("reporting_view",$isiform);
