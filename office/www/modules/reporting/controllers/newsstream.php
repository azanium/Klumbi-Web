...
class Newsstream extends CI_Controller 
{
    public function __construct() {
        ...
        $this->m_checking->module("News Stream Report","module13",FALSE,TRUE,"home");
    }
    function index()
    {
        ...
        $this->template_admin->header_web(TRUE,"News Report",$css,$js,TRUE,"");
        ...
        $config['base_url'] = $this->template_admin->link("reporting/newsstream/index","?page=news&dt=list");
        ...
        $this->load->view("newsstream_view",$isiform);
