...
class Banner extends CI_Controller 
{
    public function __construct() {
        ...
        $this->m_checking->module("Banner Report","module13",FALSE,TRUE,"home");
    }
    function index()
    {
        ...
        $this->template_admin->header_web(TRUE,"Banner Report",$css,$js,TRUE,"");
        ...
        $config['base_url'] = $this->template_admin->link("reporting/banner/index","?page=banner&dt=list");
        ...
        $isiform['listbanner']=$this->mongo_db->find(array(),(int)$start,$config['per_page'],array('name'=>1));
        $isiform['startfrom'] = (int)$start;
        $this->load->view("banner_view",$isiform);
