...
$(document).ready(function() {
    dttable=$('#datatable').dataTable( {
        ...
        "bFilter": true,
        "bServerSide": true,
        "sAjaxSource": "<?php echo $this->template_admin->link("user/deactivated/list_data"); ?>",
...
function hapusdata(id,pesan)
{
    BootstrapDialog.confirm(pesan, function(result){
        if(result) 
        {
            var url='<?php echo base_url(); ?>user/deactivated/delete/'+id;
            $.ajax({
                    type: "POST",
                    url: url,
                    data:"",
...
function setactive(id,pesan)
{
    BootstrapDialog.confirm(pesan, function(result){
        if(result) 
        {
            var url='<?php echo base_url(); ?>user/deactivated/setactive/'+id;
            $.ajax({
                    type: "POST",
                    url: url,
                    data:"",
