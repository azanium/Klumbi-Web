...
$(document).ready(function() {
    ...
    dttable=$('#datatable').dataTable( {
        ...
        "bFilter": true,
        "bServerSide": true,
        "sAjaxSource": "<?php echo $this->template_admin->link("inventory/mgcolor/list_data"); ?>",
        ...
        "aoColumns": [ { "sClass" : "alignRight","bSortable": false }, null, {"bSortable": false},{"sClass" : "text-center"}, {"bSortable": false}, { "sClass" : "text-center","bSortable": false }]
    });
...
function hapusdata(id,pesan)
{
    BootstrapDialog.confirm(pesan, function(result){
        if(result) 
        {
            var url='<?php echo base_url(); ?>inventory/mgcolor/delete/'+id;
            $.ajax({
                    type: "POST",
                    url: url,
                    data:"",
                ...
                <div class="panel-heading">
                    ...
                    <div class="options">
                        <ul class="nav nav-tabs">
                          <li class="active"><a href="#listdata" data-toggle="tab"><i class="icon-table"></i> Colors</a></li>
                          <li><a href="#addnewdata" data-toggle="tab"><i class="icon-plus"></i> Create Color</a></li>
                        </ul>
                ...
                <div class="panel-body collapse in">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="addnewdata">
                            <form method="POST" class="form-horizontal" id="brandfrm" action="<?php echo $this->template_admin->link("inventory/mgcolor/cruid_color"); ?>">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <p class="help-block">Name of Color!</p>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="txtskincolor" class="col-sm-3 control-label">Color</label>
                                    <div class="col-sm-6">
                                        <input type="text" name="txtskincolor" id="txtskincolor" data-color-format="rgba" value="rgba(255, 255, 255,1)" maxlength="255" placeholder="Color" class="form-control cpicker {required:true}" />
                                    </div>
                                    <div class="col-sm-3">
                                        <p class="help-block">RGBA Color!</p>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <?php
                                        if($this->m_checking->actions("Color","module6","Add",TRUE,FALSE,"home"))
                                        {
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" id="editbrandfrm" action="<?php echo $this->template_admin->link("inventory/mgcolor/cruid_color"); ?>">
                    <table class="table table-striped table-bordered table-hover" cellpadding="0" cellspacing="0" border="0">
                        ...
                        <tr>
                            <td><label for="txtskincolor2">RGBA Color</label></td>
                            <td>
                                <input type="text" name="txtskincolor" id="txtskincolor2" data-color-format="rgba" value="rgba(255, 255, 255,1)" maxlength="255" placeholder="Color" class="form-control cpicker {required:true}" />
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php 
                                if($this->m_checking->actions("Color","module6","Edit",TRUE,FALSE,"home"))
                                {
