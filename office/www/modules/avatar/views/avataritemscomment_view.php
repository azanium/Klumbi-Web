...
$(document).ready(function() {
    dttable=$('#datatable').dataTable( {
        ...
        "bFilter": false,
        "bServerSide": true,
        "sAjaxSource": "<?php echo $this->template_admin->link("avatar/avataritems/list_itemdatacommet/".$id_avatar); ?>",
...
function hapusdata(id,pesan)
{
    BootstrapDialog.confirm(pesan, function(result){
        if(result) 
        {
            var url='<?php echo base_url(); ?>avatar/avataritems/delete/'+id;
            $.ajax({
                    type: "POST",
                    url: url,
                    data:"",
        ...
        <div class="col-md-12">
            <div class="panel panel-purple">
                <div class="panel-heading">
                    <h4>List Comments Avatar Item</h4>
                    <div class="options">
