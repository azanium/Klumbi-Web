...
$(document).ready(function() {
    ...
    dttable=$('#datatable').dataTable( {
        ...
        "bFilter": true,
        "bServerSide": true,
        "sAjaxSource": "<?php echo $this->template_admin->link("content/news/list_data"); ?>",
...
function hapusdata(id,pesan)
{
    BootstrapDialog.confirm(pesan, function(result){
        if(result) 
        {
            var url='<?php echo base_url(); ?>content/news/delete/'+id;
            $.ajax({
                    type: "POST",
                    url: url,
                    data:"",
                ...
                <div class="panel-heading">
                    ...
                    <div class="options">
                        <ul class="nav nav-tabs">
                          <li class="active"><a href="#listdata" data-toggle="tab"><i class="icon-table"></i> News</a></li>
                          <li><a href="#addnewdata" data-toggle="tab"><i class="icon-plus"></i> Create News</a></li>
                        </ul>
                ...
                <div class="panel-body collapse in">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="addnewdata">
                            <form method="POST" class="form-horizontal" id="brandfrm" action="<?php echo $this->template_admin->link("content/news/cruid_news"); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="contentarticle" id="<?php echo $classword; ?>" class="<?php echo $classword; ?> form-control" cols="45" rows="10"></textarea>
                                    </div>
                                </div>
                            </form>
                        </div>
