...
$(document).ready(function() {
    ...
    dttable=$('#datatable').dataTable( {
        ...
        "bFilter": true,
        "bServerSide": true,
        "sAjaxSource": "<?php echo $this->template_admin->link("content/category/list_data"); ?>",
...
function hapusdata(id,pesan)
{
    BootstrapDialog.confirm(pesan, function(result){
        if(result) 
        {
            var url='<?php echo base_url(); ?>content/category/delete/'+id;
            $.ajax({
                    type: "POST",
                    url: url,
                    data:"",
                ...
                <div class="panel-heading">
                    ...
                    <div class="options">
                        <ul class="nav nav-tabs">
                          <li class="active"><a href="#listdata" data-toggle="tab"><i class="icon-table"></i> Business Categories</a></li>
                          <li><a href="#addnewdata" data-toggle="tab"><i class="icon-plus"></i> Create Business Category</a></li>
                        </ul>
                ...
                <div class="panel-body collapse in">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="addnewdata">
                            <form method="POST" class="form-horizontal" id="brandfrm" action="<?php echo $this->template_admin->link("content/category/cruid_category"); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <?php 
                                        if($this->m_checking->actions("Content Category","module9","Add",TRUE,FALSE,"home"))
                                        {
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" id="editbrandfrm" action="<?php echo $this->template_admin->link("content/category/cruid_category"); ?>">
                    <table class="table table-striped table-bordered table-hover" cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            ...
                            <td>
                                <input type="text" name="name" id="name2" value="" maxlength="255" placeholder="Category Name" class="form-control {required:true}" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php 
                                if($this->m_checking->actions("Content Category","module9","Edit",TRUE,FALSE,"home"))
                                {
