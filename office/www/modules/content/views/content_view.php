...
$(document).ready(function() {
    ...
    dttable=$('#datatable').dataTable( {
        ...
        "bFilter": true,
        "bServerSide": true,
        "sAjaxSource": "<?php echo $this->template_admin->link("content/list_data"); ?>",
...
function hapusdata(id,pesan)
{
    BootstrapDialog.confirm(pesan, function(result){
        if(result) 
        {
            var url='<?php echo base_url(); ?>content/delete/'+id;
            $.ajax({
                    type: "POST",
                    url: url,
                    data:"",
                ...
                <div class="panel-body collapse in">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="addnewdata">
                            <form method="POST" class="form-horizontal" id="brandfrm" action="<?php echo $this->template_admin->link("content/cruid_content"); ?>">
