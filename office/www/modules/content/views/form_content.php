    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Form Edit Content</h4>
            </div>
            <div class="modal-body">
                <form method="POST" id="editbrandfrm" action="<?php echo $this->template_admin->link("content/cruid_content"); ?>">
                    <table class="table table-striped table-bordered table-hover" cellpadding="0" cellspacing="0" border="0">
                        ...
                        <tr>
                            <td colspan="2"><textarea name="contentarticle" id="<?php echo $classword; ?>" class="<?php echo $classword; ?>" cols="45" rows="10"><?php echo $contentpage; ?></textarea></td>
                        </tr>
                    </table>
                </form>
            </div>
