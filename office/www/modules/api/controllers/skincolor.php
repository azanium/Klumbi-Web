...
class Skincolor extends CI_Controller 
{
    ...
    /*
     * Methode : GET
     * API Get One Detail Skincolor
     * Parameter :
     * 1. _id field _id from Database Assets dan collection SkinColor (this param is required)
     * Return JSON
     */
    ...
    {  
        ...
        if($ceklogin)
        {
            ...
            $tempdt = $this->mongo_db->findOne(array("code"=>"limitskincolor"));
            $limit = 10;
            if($tempdt)
            {
                $limit = $tempdt['value'];
