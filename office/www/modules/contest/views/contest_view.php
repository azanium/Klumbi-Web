...
function tambahconfigrequired()
{
    ...
    newsetvalreq += "<div class='btn-toolbar'>";
    newsetvalreq += "<div class='btn-group-vertical'>";
    newsetvalreq += "<button type='button' class='btn btn-green' onclick='setvalbrand(\"" + tagid + "\",\"lovebrand\");return false;'><i class='icon-heart'></i> Store</button>";    
    newsetvalreq += "<button type='button' class='btn btn-green' onclick='setvalbrand(\"" + tagid + "\",\"commentbrand\");return false;'><i class='icon-comment-alt'></i> Store</button>";
    ...
    newsetvalreq += "<div class='btn-toolbar'>";
    newsetvalreq += "<div class='btn-group-vertical'>";
    newsetvalreq += "<button type='button' class='btn btn-magenta' onclick='setvalavamix(\"" + tagid + "\",\"sendavatarmix\");return false;'><i class='icon-gift'></i> Send User Mix</button>";
    newsetvalreq += "<button type='button' class='btn btn-magenta' onclick='setvalavamix(\"" + tagid + "\",\"loveavatarmix\");return false;'><i class='icon-heart'></i> User Mix</button>";    
    newsetvalreq += "<button type='button' class='btn btn-magenta' onclick='setvalavamix(\"" + tagid + "\",\"commentavatarmix\");return false;'><i class='icon-comment-alt'></i> User Mix</button>";
    newsetvalreq += "<button type='button' class='btn btn-magenta' onclick='setvalavamix(\"" + tagid + "\",\"useavatarmix\");return false;'><i class='icon-ok'></i> Collect User Mix</button>";
    newsetvalreq += "</div>";
    newsetvalreq += "</div>";
    newsetvalreq += "</div>";
                ...
                <div class="panel-heading">
                    ...
                    <div class="options">
                        <ul class="nav nav-tabs">
                          ...
                          <li><a href="#addnewdata" data-toggle="tab"><i class="icon-plus"></i> Create Contest</a></li>
                        </ul>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="addnewdata">
                            <form method="POST" class="form-horizontal" id="brandfrm" action="<?php echo $this->template_admin->link("contest/cruid_contest"); ?>">
                                ...
                                <div class="form-group">
                                    <label for="descriptions" class="col-sm-3 control-label">Prize</label>
                                    <div class="col-sm-6">
                                        <textarea name="descriptions" id="descriptions" class="form-control autosize" cols="55" rows="3"></textarea>
                                    </div>
                                    <div class="col-sm-3">
                                        <p class="help-block">Prize of Contest!</p>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="infodetail" class="col-sm-3 control-label">Mission</label>
                                    <div class="col-sm-6">
                                        <textarea name="infodetail" id="infodetail" class="form-control autosize" cols="55" rows="3"></textarea>
                                    </div>
                                    <div class="col-sm-3">
                                        <p class="help-block">Mission of Contest!</p>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <p class="help-block">Store of Contest!</p>
                                    </div>
                                </div>
                                <?php
                                }
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <?php 
                                        if($this->m_checking->actions("Contest","module5","Add",TRUE,FALSE,"home"))
                                        {
            ...
            <div class="modal-body">
                <form method="POST" id="editbrandfrm" action="<?php echo $this->template_admin->link("contest/cruid_contest"); ?>">
                    <table class="table table-striped table-bordered table-hover" cellpadding="0" cellspacing="0" border="0">
                        ...
                        <tr>
                            <td>
                                <label for="descriptions2">Prize</label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <label for="infodetail2">Mission</label>
                            </td>
                            <td>
